...
// NewGetBroadcastsIDParams creates a new GetBroadcastsIDParams object
// with the default values initialized.
func NewGetBroadcastsIDParams() *GetBroadcastsIDParams {
	var ()
	return &GetBroadcastsIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetBroadcastsIDParamsWithTimeout creates a new GetBroadcastsIDParams object
...
// NewGetBroadcastsIDParamsWithContext creates a new GetBroadcastsIDParams object
...
// NewGetBroadcastsIDParamsWithHTTPClient creates a new GetBroadcastsIDParams object
...
/*GetBroadcastsIDParams contains all the parameters to send to the API endpoint
for the get broadcasts ID operation typically these are written to a http.Request
*/
...
func (o *GetBroadcastsIDParams) WithContext(ctx context.Context) *GetBroadcastsIDParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetBroadcastsIDParams) WithID(id int64) *GetBroadcastsIDParams {
	o.SetID(id)
	return o
}
